...
namespace Csharp_Parser
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.textBox_Output.Size = new System.Drawing.Size(200, 43);
			this.textBox_Output.TabIndex = 0;
			this.textBox_Output.Text = "esgl";
			...
			this.button_7.Click += new System.EventHandler(this.button4_Click);
			// 
			// button_Slash
			// 
			...
			this.button_4.Click += new System.EventHandler(this.button4_Click_1);
			// 
			// button_Minus
			// 
			...
			this.button_1.Click += new System.EventHandler(this.button4_Click_2);
			// 
			// button_Plus
			// 
			...
			this.button_Point.Click += new System.EventHandler(this.button4_Click_3);
			// 
			// Form1
			// 
